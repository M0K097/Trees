...
public class BinarySearchTree
{
    ...
    public BstNode? rotateRight(BstNode node)
    {
        ...
        if (pivot != null)
        {
            ...
            TreeHelper.updateSingleNodeHeight(node);
            TreeHelper.updateSingleNodeHeight(pivot);
        }
        return pivot;
    }
    ...
    public BstNode? rebalance(BstNode? node)
    {
        if (node == null)
        {
            return null;
        }
        else if(node.leftChild != null && node.balanceFactor < -1)
        {
        ...
        else if(node.rightChild != null && node.balanceFactor > 1)
        {
